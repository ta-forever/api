...
DELETE FROM `league`;
DELETE FROM `league_rating_range`;
DELETE FROM `league_schedule`;
...
DELETE FROM `swiss_tournaments`;
DELETE FROM `swiss_tournaments_players`;
...
DELETE FROM `updates_engyredesign`;
DELETE FROM `updates_engyredesign_files`;
...
DELETE FROM `updates_matchmaker`;
DELETE FROM `updates_matchmaker_files`;
...
DELETE FROM `updates_supremeDestruction`;
DELETE FROM `updates_supremeDestruction_files`;
...
DELETE FROM `updates_wyvern`;
DELETE FROM `updates_wyvern_files`;
